          ...
          <div className="max-w-3xl">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-8 backdrop-blur-sm">
              <p className="text-lg text-white/90 leading-relaxed">
                Position your Richmond business in AI search and voice results. Webvello's remote GEO services ensure your Richmond business surfaces when AI engines field customer queries—positioning you ahead of competitors who haven't optimized for AI search yet. We serve organizations <Link href="/services/virginia" className="text-blue-400 hover:underline">throughout Virginia</Link>.
              </p>
            </div>
