    ...
    <>
      {(() => {
        const schema = generateServicePageSchema(
          { name: "Generative Engine Optimization", description: "Professional Generative Engine Optimization services", url: "https://webvello.com/services/generative-engine-optimization" },
          servicePageFAQs,
