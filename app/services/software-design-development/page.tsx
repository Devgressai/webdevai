    ...
    <>
      {(() => {
        const schema = generateServicePageSchema(
          { name: "Software Design Development", description: "Professional Software Design Development services", url: "https://webvello.com/services/software-design-development" },
          servicePageFAQs,
