    ...
    <>
      {(() => {
        const schema = generateServicePageSchema(
          { name: "Answer Engine Optimization", description: "Professional Answer Engine Optimization services", url: "https://webvello.com/services/answer-engine-optimization" },
          servicePageFAQs,
