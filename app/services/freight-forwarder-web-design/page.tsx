        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 grid md:grid-cols-3 gap-8 text-center">
              <div><Phone className="h-8 w-8 mx-auto mb-3 text-orange-300" /><div className="font-semibold mb-1">Call Us</div><a href="tel:+15305538883" className="text-orange-200 hover:text-white">(530) 553-8883</a></div>
