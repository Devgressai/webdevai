          ...
          <div className="max-w-3xl">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 mb-8 backdrop-blur-sm">
              <p className="text-lg text-white/90 leading-relaxed">
                Dominate AI search when St. Louis residents look for your services. Webvello's remote GEO services ensure your St. Louis business surfaces when AI engines field customer queries—positioning you ahead of competitors who haven't optimized for AI search yet. We serve organizations <Link href="/services/missouri" className="text-red-400 hover:underline">throughout Missouri</Link>.
              </p>
            </div>
