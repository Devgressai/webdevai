    ...
    <>
      {(() => {
        const schema = generateServicePageSchema(
          { name: "Web Application Development Chicago", description: "Professional Web Application Development Chicago services", url: "https://webvello.com/services/web-application-development-chicago" },
          servicePageFAQs,
