...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      // Google prefers 192x192 or larger, multiple of 48px - prioritize these
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://www.webvello.com/api/og?title=Web%20Vello&subtitle=GEO%20%26%20SEO%20Agency%20%7C%20AI%20Search%20Optimization',
        width: 1200,
        height: 630,
        alt: 'Web Vello - GEO & SEO Agency with code preview showing AI-driven optimization',
      },
    ],
  },
  twitter: {
    ...
    title: 'Web Vello - GEO & SEO Agency | AI Search Optimization',
    description: 'Get found in ChatGPT, Perplexity, and Google. AI-powered SEO and custom web development.',
    images: ['https://www.webvello.com/api/og?title=Web%20Vello&subtitle=GEO%20%26%20SEO%20Agency'],
    creator: '@webvello',
    site: '@webvello',
  },
  robots: {
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} ${poppins.variable}`}>
      <head>
        {/* SVG favicon - modern browsers and Google Search */}
        <link rel="icon" type="image/svg+xml" href="/favicon.svg" />
        {/* Primary favicon for Google Search - must be 192x192 or larger, multiple of 48px */}
