#!/usr/bin/env node
/**
 * GEO Page Generator for New Cities
 * Creates GEO service pages following the established pattern
 */
...
// Industry configurations for different city types
const techIndustries = [
  { icon: 'Building2', name: 'Tech & Software', description: 'SaaS companies and tech startups' },
  { icon: 'TrendingUp', name: 'Professional Services', description: 'Consulting and business services' },
  { icon: 'Briefcase', name: 'Financial Services', description: 'Fintech and financial advisors' },
  { icon: 'Users', name: 'Healthcare Tech', description: 'Digital health and medical services' },
  { icon: 'Star', name: 'Real Estate', description: 'Commercial and residential brokers' },
  { icon: 'ShoppingBag', name: 'E-commerce', description: 'Online retail and marketplaces' }
];

const generalIndustries = [
  { icon: 'Building2', name: 'Professional Services', description: 'Law, accounting, and consulting' },
  { icon: 'TrendingUp', name: 'Real Estate', description: 'Brokers and property management' },
  { icon: 'Wrench', name: 'Home Services', description: 'HVAC, plumbing, and contractors' },
  { icon: 'Users', name: 'Healthcare', description: 'Medical practices and providers' },
  { icon: 'Star', name: 'Restaurants', description: 'Dining and food service' },
  { icon: 'ShoppingBag', name: 'Retail', description: 'Local shops and boutiques' }
];

// Generate unique process steps for each city
...
// Generate neighborhoods (generic but realistic)
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 border border-slate-200">
              <Globe className="w-10 h-10 mb-4 text-transparent bg-gradient-to-r from-${gradient} bg-clip-text" style={{WebkitTextFillColor: 'transparent', WebkitBackgroundClip: 'text'}} />
            ...
            <div className="bg-white rounded-xl p-8 border border-slate-200">
              <Target className="w-10 h-10 mb-4 text-transparent" style={{stroke: 'url(#grad)'}} />
              <svg width="0" height="0"><defs><linearGradient id="grad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style={{stopColor: 'rgb(37, 99, 235)', stopOpacity: 1}} /><stop offset="100%" style={{stopColor: 'rgb(59, 130, 246)', stopOpacity: 1}} /></linearGradient></defs></svg>
            ...
            <div className="bg-white rounded-xl p-8 border border-slate-200">
              <BarChart className="w-10 h-10 mb-4" style={{stroke: 'url(#grad2)'}} />
              <svg width="0" height="0"><defs><linearGradient id="grad2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style={{stopColor: 'rgb(37, 99, 235)', stopOpacity: 1}} /><stop offset="100%" style={{stopColor: 'rgb(59, 130, 246)', stopOpacity: 1}} /></linearGradient></defs></svg>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
            {industries.map((industry) => {
              const Icon = industry.icon === 'Building2' ? Building2 : 
                           industry.icon === 'TrendingUp' ? TrendingUp :
                           industry.icon === 'Wrench' ? Wrench :
                           industry.icon === 'Users' ? Users :
                           industry.icon === 'Star' ? Star :
                           industry.icon === 'ShoppingBag' ? ShoppingBag :
                           industry.icon === 'Briefcase' ? Briefcase : Building2;
              return (
                <div key={industry.name} className="bg-white rounded-xl p-6 border border-slate-200">
                  <Icon className="w-10 h-10 mb-4 bg-gradient-to-r from-${gradient} bg-clip-text" style={{color: 'transparent', WebkitTextStroke: '2px'}} />
...
// Main execution
console.log(`🚀 Generating ${cities.length} GEO pages...\n`);
...
cities.forEach(city => {
  ...
  if (fs.existsSync(filePath)) {
    console.log(`⏭️  SKIPPED: ${city.city}, ${city.abbr} (file exists)`);
    skipped++;
    return;
  }
  ...
  console.log(`✅ CREATED: ${city.city}, ${city.abbr} → /services/geo-${city.slug}/page.tsx`);
  created++;
});
...
console.log(`\n✨ Done! All new GEO pages generated.`);
