...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: '/:path*',
        has: [{ type: 'host', value: 'www.webvello.com' }],
        destination: 'https://webvello.com/:path*',
        permanent: true,
      },
      // Canonicalize malformed city-service slugs by stripping trailing city/state tails
      // Examples: /:city/website-design-oklahoma-city -> /:city/website-design
      { source: '/:city([a-z-]+-[a-z]{2})/website-design-:tail', destination: '/:city/website-design', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/web-development-:tail', destination: '/:city/web-development', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/wordpress-development-:tail', destination: '/:city/wordpress-development', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/shopify-development-:tail', destination: '/:city/shopify-development', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/ui-ux-design-:tail', destination: '/:city/ui-ux-design', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/app-design-development-:tail', destination: '/:city/app-design-development', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/software-development-:tail', destination: '/:city/software-development', permanent: true },
      // Common mis-slug mapping to closest canonical
      { source: '/:city([a-z-]+-[a-z]{2})/web-application-development-:tail', destination: '/:city/web-development', permanent: true },
      // SEO variants
      { source: '/:city([a-z-]+-[a-z]{2})/seo-company-:tail', destination: '/:city/seo', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/seo-services-:tail', destination: '/:city/seo', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/seo-:tail', destination: '/:city/seo', permanent: true },
      // Industry prefixed mis-slugs that should map to core services
      { source: '/:city([a-z-]+-[a-z]{2})/auto-repair-website-design-:tail', destination: '/:city/website-design', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/medical-website-design-:tail', destination: '/:city/website-design', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/real-estate-seo-:tail', destination: '/:city/seo', permanent: true },
      // Catch common pairings we saw in GSC
      { source: '/:city([a-z-]+-[a-z]{2})/web-design-:tail', destination: '/:city/website-design', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/web-development-:tail', destination: '/:city/web-development', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/email-marketing-design-:tail', destination: '/:city/email-marketing-design', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/social-media-design-:tail', destination: '/:city/social-media-design', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/cro-ecommerce-:tail', destination: '/:city/cro-ecommerce', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/cro-lead-generation-:tail', destination: '/:city/cro-lead-generation', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/ai-gpt-integration-:tail', destination: '/:city/ai-gpt-integration', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/ai-agent-development-:tail', destination: '/:city/ai-agent-development', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/ai-digital-marketing-:tail', destination: '/:city/ai-digital-marketing', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/ai-seo-:tail', destination: '/:city/ai-seo', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/generative-engine-optimization-:tail', destination: '/:city/generative-engine-optimization', permanent: true },
      { source: '/:city([a-z-]+-[a-z]{2})/answer-engine-optimization-:tail', destination: '/:city/answer-engine-optimization', permanent: true },
