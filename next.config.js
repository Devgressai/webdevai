...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/:city/website-design-:tail', destination: '/:city/website-design', permanent: true },
      { source: '/:city/web-development-:tail', destination: '/:city/web-development', permanent: true },
      { source: '/:city/wordpress-development-:tail', destination: '/:city/wordpress-development', permanent: true },
      { source: '/:city/shopify-development-:tail', destination: '/:city/shopify-development', permanent: true },
      { source: '/:city/ui-ux-design-:tail', destination: '/:city/ui-ux-design', permanent: true },
      { source: '/:city/app-design-development-:tail', destination: '/:city/app-design-development', permanent: true },
      { source: '/:city/software-development-:tail', destination: '/:city/software-development', permanent: true },
      // Common mis-slug mapping to closest canonical
      { source: '/:city/web-application-development-:tail', destination: '/:city/web-development', permanent: true },
      // SEO variants
      { source: '/:city/seo-company-:tail', destination: '/:city/seo', permanent: true },
      ...
      { source: '/:city/web-design-:tail', destination: '/:city/website-design', permanent: true },
      { source: '/:city/web-development-:tail', destination: '/:city/web-development', permanent: true },
      { source: '/:city/email-marketing-design-:tail', destination: '/:city/email-marketing-design', permanent: true },
      { source: '/:city/social-media-design-:tail', destination: '/:city/social-media-design', permanent: true },
      { source: '/:city/cro-ecommerce-:tail', destination: '/:city/cro-ecommerce', permanent: true },
      { source: '/:city/cro-lead-generation-:tail', destination: '/:city/cro-lead-generation', permanent: true },
      { source: '/:city/ai-gpt-integration-:tail', destination: '/:city/ai-gpt-integration', permanent: true },
      { source: '/:city/ai-agent-development-:tail', destination: '/:city/ai-agent-development', permanent: true },
      { source: '/:city/ai-digital-marketing-:tail', destination: '/:city/ai-digital-marketing', permanent: true },
      { source: '/:city/ai-seo-:tail', destination: '/:city/ai-seo', permanent: true },
      { source: '/:city/generative-engine-optimization-:tail', destination: '/:city/generative-engine-optimization', permanent: true },
      { source: '/:city/answer-engine-optimization-:tail', destination: '/:city/answer-engine-optimization', permanent: true },
